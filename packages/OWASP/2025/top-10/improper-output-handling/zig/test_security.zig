...
test "defense" { const cleaned = try lib.LLM_1ntruder.clean(std.testing.allocator, "Improper Output Handling", "x <script"); try std.testing.expect(std.mem.indexOf(u8, cleaned, "<script") == null); }
